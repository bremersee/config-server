    ...
    stage('Deploy Snapshot On Data') {
      ...
      steps {
        withCredentials([
          ...
          sh 'echo docker-host=$docker-host'
          sh 'echo docker-ca=$docker-ca'
          sh 'echo docker-cert=$docker-cert'
          sh 'echo docker-key=$docker-key'
          sh 'echo keystore=$ks'
          sh 'echo keystore-password=$ks-password'
          sh 'echo keystore-entry=$alias $secret'
